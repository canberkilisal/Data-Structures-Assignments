...
void HashTable<Key, Value>::printInfo() const
{
	...
	cout << "\n\nAfter preprocessing, the unique word count is " << currentSize << ". Current load ratio is " << loadRatio << endl;
}
...
void HashTable<Key, Value>::rehash()
{
	...
	double oldArraySize = oldArray.size();
	double newArraySize = hashArray.size();
	double loadRatio = currentSize / newArraySize;

	cout << "rehashed..." << endl;
	cout << "previous table size : " << oldArraySize << ", new table size : "
		<< newArraySize << ", current unique word count " << currentSize
		<< ", current load factor: " << loadRatio << endl;
}
